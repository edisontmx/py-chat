...
#python dict. Store connected users. Key is socket id value is username and avatar URL
users={}
...
def handle_connect():
    ...
    avatar_url= f"https://avatar.iran.liara.run/public/{gender}?username=User_123"
    ...
    emit("set_username", {"user_name": username})
